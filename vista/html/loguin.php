...
<body class="bodyContenedor">
  <div class="login-box">
    ...
    <form  action="" method="post">
      ...
      <input type="text" class="form-control is-valid" placeholder="Ingrese Usuario" name="usuario_log" id="user" pattern="[a-zA-Z0-9]{1,35}" aria-describedby="inputGroupPrepend3 userFeedback" required autocomplete="off">
      <div id="userFeedback" class="invalid-feedback">
          Please choose a username.
      </div>
      
      <label for="password">Contraseña</label>
      <input type="password" class="form-control is-valid" placeholder="Ingrese Contraseña" name="password_log" id="password" pattern="[a-zA-Z0-9$@.-]{7,100}" aria-describedby="inputGroupPrepend3 passwordFeedback" required autocomplete="off">
...
<<?php 
  ...
  if (isset($_POST['usuario_log']) AND isset($_POST['password_log'])) {
